    ...
    return (
      <div className="key-highlights-container">
        <div className="background">
          <img src="/assets/Frame 2 (1).png" alt="Background Frame" className="frame-image" />
          <img src="/assets/Frame 2 (1).png" alt="Background Frame" className="frame-image" />
          <img src="/assets/Frame 2 (1).png" alt="Background Frame" className="frame-image" />
          <img src="/assets/Frame 2 (1).png" alt="Background Frame" className="frame-image" />
        </div>
        <div className="highlights-content">
          ...
          <img src="/assets/Group 16.png" alt="Red Box" className="red-box" />
          <img src="/assets/Wallet.png" alt="Red Box" className="wallet-image" />
          <img src="/assets/Support Based Monetization.png" alt="Red Box" className="wallet-image-text" />
