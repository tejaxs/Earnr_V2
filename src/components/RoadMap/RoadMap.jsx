...
function Roadmap() {
  return (
    <div className="relative md:mt-40 mt-0 md:mb-20 flex flex-col items-center justify-center overflow-hidden">
      <h1 className="md:text-[5rem] text-[3rem] text-white urbanist-700">
        GAME PLAN
      </h1>
  ...
  >
    {Array.from({ length: 10 }).map((_, index) => (
      <span
        key={index}
        className="yellow-strip-1 transform urbanist-700 text-[24px] bg-[#FA9928] text-[#111]"
      >
