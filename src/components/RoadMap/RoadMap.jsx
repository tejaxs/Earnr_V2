      ...
      <div className="roadmap-container">
        ...
        <div className="boxes-container">
          <div className="roadmap-box">
            <img src="/assets/Group 25 (1).png" alt="" className='engagment-image'/>
          </div>
          <div  className="roadmap-box">
            <img src="/assets/Group 26.png" alt="" className='engagment-image'/>
          </div>
          <div className="roadmap-box">
          <img src="/assets/Group 27.png" alt="" className='engagment-image'/>
          </div>
        </div>
